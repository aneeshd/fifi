...
namespace fifi
{
    ...
    class ssse3_dispatcher : public Super
    { };


    /// @todo
    template<class Stack, class Super>
    class ssse3_dispatcher<typename Stack::field_type, Stack, Super>
        : public Super
    {
    public:
        ...
        /// We expect the field to be the same
        static_assert(std::is_same<field_type, typename Stack::field_type>::value,
                      "We expected the Super to use the same field");
    ...
    public:
        ...
        {
            if(m_stack.ssse3_binary4_full_table_enabled())
            {
        ...
        bool ssse3_enabled() const
        {
            cpuid::cpuinfo info;
            return info.has_ssse3() &&
                   m_stack.ssse3_binary4_full_table_enabled();
        }

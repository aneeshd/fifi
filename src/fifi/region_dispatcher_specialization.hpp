...
namespace fifi
{
    ...
    public:
        ...
        struct bind_add
        {
            ...
            decltype(std::declval<T>().region_add(0,0,0),
        ...
        struct bind_divide
        {
            template<class T>
            static auto bind(const T* t) ->
            decltype(std::declval<T>().region_divide(0,0,0),
        ...
        struct bind_multiply_constant
        {
            template<class T>
            static auto bind(const T* t) ->
            decltype(std::declval<T>().region_multiply_constant(0,0,0),
        ...
        struct bind_multiply_add
        {
            template<class T>
            static auto bind(const T* t) ->
            decltype(std::declval<T>().region_multiply_add(0,0,0,0),
        ...
        struct bind_multiply_subtract
        {
            template<class T>
            static auto bind(const T* t) ->
            decltype(std::declval<T>().region_multiply_subtract(0,0,0,0),
    ...
    public:
        ...
        {
            auto call = bind_multiply_constant_test(0);
        ...
        {
            auto call = bind_multiply_add_test(0);
        ...
        {
            auto call = bind_multiply_subtract_test(0);
    ...
    protected:
        ...
        auto bind_add_test(int) const ->
            decltype(sak::easy_bind(&T::region_add,
                                    static_cast<T*>(0)),
                     call_region_add())
        {
            return sak::easy_bind(&T::region_add, &m_stack);
        }

        template<class T = Stack>
        auto bind_add_test(char) const ->
            decltype(call_region_add())
        {
            return call_region_add();
        }

        template<class T = Stack>
        auto bind_subtract_test(int) const ->
            decltype(sak::easy_bind(&T::region_subtract,
                                    static_cast<T*>(0)),
                     call_region_subtract())
        {
            return sak::easy_bind(&T::region_subtract, &m_stack);
        }

        template<class T = Stack>
        auto bind_subtract_test(char) const ->
            decltype(call_region_subtract())
        {
        ...
        auto bind_multiply_test(int) const ->
            decltype(sak::easy_bind(&T::region_multiply,
                                    static_cast<T*>(0)),
                     call_region_multiply())
        {
        ...
        auto bind_divide_test(int) const ->
            decltype(sak::easy_bind(&T::region_divide,
                                    static_cast<T*>(0)),
                     call_region_divide())
        {
        ...
        template<class T = Stack>
        auto bind_multiply_constant_test(char) const ->
            decltype(call_region_multiply_constant())
        {
        ...
        template<class T = Stack>
        auto bind_multiply_add_test(char) const ->
            decltype(call_region_multiply_add())
        {
        ...
        template<class T = Stack>
        auto bind_multiply_subtract_test(char) const ->
            decltype(call_region_multiply_subtract())
        {

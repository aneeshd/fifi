...
TEST(test_ssse3_binary8_full_table, region_subtract)
{
    fifi::ssse3_binary8_full_table stack;
    if (stack.enabled())
    {
...
TEST(test_ssse3_binary8_full_table, region_multiply_constant)
{
    fifi::ssse3_binary8_full_table stack;
    if (stack.enabled())
    {
...
TEST(test_ssse3_binary8_full_table, region_multiply_add)
{
    fifi::ssse3_binary8_full_table stack;
    if (stack.enabled())
    {
...
TEST(test_ssse3_binary8_full_table, region_multiply_subtract)
{
    fifi::ssse3_binary8_full_table stack;
    if (stack.enabled())
    {

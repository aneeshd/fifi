...
// void check_results_multiply(Operation operation)
// {
//     uint32_t size = expected_multiply_binary8_size;

//     for(uint32_t i = 0; i < size; ++i)
//     {
// 	expected_result_2<Field> res = expected_multiply_binary8[i];
...
TEST(test_extended_log_table, binary8add)
{
	...
	EXPECT_EQ(extlogtable.add(res.arg1, res.arg2), res.result);
    }
}
